// ===================== Focinhos - frontend (build estático) =====================
// Versão para GitHub Pages: a API roda no navegador via store.js (localStorage),
// sem backend Python. Mesma assinatura de api() do app original.

const api = async (path, opts = {}) => window.localApi(path, opts);
